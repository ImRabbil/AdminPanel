                             ...
                             <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"> View Attendance Employees
                                            <a href="{{ route('all.attendance')}}" class="btn btn-sm btn-info pull-right">Back to</a>

                                        </h3>
                                    </div>
                                    <h3 class="text-danger" align="center"> View Attendace {{ $date->att_date}}</h3>
