                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td>
                                                                ...
                                                                <a href="{{route('delete-customer', $row->id)}}" id="delete" class="btn btn-sm btn-danger">Delete</a>
                                                                <a href="{{route('view-customer', $row->id)}}"class="btn btn-sm btn-success">View</a>
                                                            </td>
                                                        </tr>
                                                        @endforeach
