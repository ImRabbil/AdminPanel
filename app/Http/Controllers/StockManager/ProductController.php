...
class ProductController extends Controller
{
    ...
    public function AllProduct()
    {
        ...
        return view('stock.all_product',compact('product'));
    }
   ...
   public function DeleteProduct($id){
       ...
       $dltuser = DB::table('products')->where('id',$id)->delete();
        ...
        // print_r($view);
        // exit();
                 return view('stock.view_product', compact('view'));
         }

         public function EditProduct($id)
         {
            $prod = DB::table('products')->where('id',$id)->first();
            return view('stock.edit_product', compact('prod'));
    ...
    {
        $product = DB::table('products')->get();
        return view('stock.stock_product',compact('product'));
     } 

     public function EditStock($id){
        $prod = DB::table('products')->where('id',$id)->first();
        return view('stock.edit_stock',compact('prod'));
