...
class PosController extends Controller
{
    ...
    public function Index()
    {
        ...
        return view('sales.pos',compact('product','customer','category'));
    }
    ...
    public function PendingOrders()
    {
        ...
        return view('sales.pending_order',compact('pending'));
    ...
    public function ViewOrder($id)
    {
        ...
        return view('sales.order_confirmation',compact('order','order_details'));
    ...
    public function SuccessOrders()
    {
        ...
        return view('sales.success_order',compact('success'));
        // echo "<pre>";
        //  print_r($success);
